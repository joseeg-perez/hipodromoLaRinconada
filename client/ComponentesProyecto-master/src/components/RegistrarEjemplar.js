...
const RegistrarEjemplar = () => {
  let [nombreEjemplar, setNombreEjemplar] = useState("");
  ...
  const handleData = async (event) => {
    ...
    try {
      await axios.post("http://localhost:3001/api/v1/ejemplares/registrar_ejemplar", { 
        nombreEjemplar,
        numeroEjemplar,
        tatlabialEjemplar,
        precioEjemplar,
              ...
              <Row className="mt-2">
                <Col className="col-6">
                  <FormGroup>
                    ...
                    <FormSelect value={padreEjemplar} onChange={handlePadre} >
                      <option>1</option>
                      <option>2</option>
                      <option>3</option>
                    </FormSelect>
