...
router.patch("/:studVestimentaId", validateId, studVestimentaController.actualizarStudVestimenta);

router.delete("/:studVestimentaId", validateId, studVestimentaController.borrarStudVestimenta);
