...
const obtenerCategoriaIndividual = async (categoriaId) => {
    try {
        const categoriaCarrera = await CategoriaCarrera.obtenerCategoriaIndividual(categoriaId);
...
const registrarCategoria = async (nuevaCategoria) => {
    try {
        const categoriaCreada = await CategoriaCarrera.registrarCategoria(nuevaCategoria);
