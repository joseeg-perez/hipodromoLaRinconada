...
const obtenerListaDeParticipacionMedicamentos = async () => {
    try {
        const listaParticipacionMedicamentos = await ParticipacionMedicamento.obtenerListaDeParticipacionMedicamentos();
...
const obtenerParticipacionMedicamentoIndividual = async (participacionMedicamentoId) => { 
    try {
        const participacionMedicamento = await ParticipacionMedicamento.obtenerParticipacionMedicamentoIndividual(participacionMedicamentoId);
...
const registrarParticipacionMedicamento = async (nuevaParticipacionMedicamento) => { 
    try {
        await ParticipacionMedicamento.registrarParticipacionMedicamento(nuevaParticipacionMedicamento);
...
const borrarParticipacionMedicamento = async (participacionMedicamentoId) => {
    try {
        await ParticipacionMedicamento.borrarParticipacionMedicamento(participacionMedicamentoId);
    } catch (error) {
        throw(error);
    }
};
