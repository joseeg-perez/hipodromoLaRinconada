...
const obtenerImplementoIndividual = async (implementoId) => {
  try {
    const implemento = await Implemento.obtenerImplementoIndividual(
      implementoId
    );
...
const registrarImplemento = async (nuevoImplemento) => {
  try {
    const implementoCreado = await Implemento.registrarImplemento(
      nuevoImplemento
    );
...
const actualizarImplemento = async (implementoId, cambios) => {
  try {
    const implementoActualizado = await Implemento.actualizarImplemento(
      implementoId,
      cambios
    );
