...
const obtenerListaDeEjemplarPropietarios = async () => {
  try {
    const listaEjemplarPropietarioes =
      await EjemplarPropietario.obtenerListaDeEjemplarPropietarios();
...
const obtenerEjemplarPropietarioIndividual = async (ejemplarPropietarioId) => {
  try {
    const ejemplarPropietario =
      await EjemplarPropietario.obtenerEjemplarPropietarioIndividual(
...
const actualizarEjemplarPropietario = async (
  ...
  try {
    await EjemplarPropietario.actualizarEjemplarPropietario(
      ejemplarPropietarioId,
      cambios
    );
