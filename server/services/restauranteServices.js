...
const obtenerRestauranteIndividual = async (restauranteId) => {
    try {
        const restaurante = await Restaurante.obtenerRestauranteIndividual(restauranteId);
...
const registrarRestaurante = async (nuevoRestaurante) => {
    try {
        const restauranteCreado = await Restaurante.registrarRestaurante(nuevoRestaurante);
