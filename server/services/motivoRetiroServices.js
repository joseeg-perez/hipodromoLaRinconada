...
const obtenerListaDeMotivosDeRetiro = async () => {
  try {
    const listaMotivoRetiros =
      await MotivoRetiro.obtenerListaDeMotivosDeRetiro();
...
const obtenerMotivoDeRetiroIndividual = async (motivoRetiroId) => {
  try {
    const motivoRetiro = await MotivoRetiro.obtenerMotivoDeRetiroIndividual(
      motivoRetiroId
    );
...
const registrarMotivoDeRetiro = async (nuevoMotivoRetiro) => {
  try {
    const motivoRetiroCreado = await MotivoRetiro.registrarMotivoDeRetiro(
      nuevoMotivoRetiro
    );
