...
const registrarVeterinarioCaballeriza = async (nuevoVeterinarioCaballeriza) => {
    try {
        await VeterinarioCaballeriza.registrarVeterinarioCaballeriza(nuevoVeterinarioCaballeriza);
...
const borrarVeterinarioCaballeriza = async (veterinarioCaballerizaId) => {
    try {
        await VeterinarioCaballeriza.borrarVeterinarioCaballeriza(veterinarioCaballerizaId);
    } catch (error) {
        throw(error);
    }
};
