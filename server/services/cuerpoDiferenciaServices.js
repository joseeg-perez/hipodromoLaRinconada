...
const obtenerListaDeCuerpoDiferencia = async () => {
  try {
    const listaCuerpoDiferencia =
      await CuerpoDiferencia.obtenerListaDeCuerpoDiferencia();
...
const obtenerCuerpoDiferenciaIndividual = async (cuerpoDiferenciaId) => {
  try {
    const cuerpoDiferencia =
      await CuerpoDiferencia.obtenerCuerpoDiferenciaIndividual(
        cuerpoDiferenciaId
      );
...
const registrarCuerpoDiferencia = async (nuevoCuerpoDiferencia) => {
  try {
    const cuerpoDiferenciaCreado =
      await CuerpoDiferencia.registrarCuerpoDiferencia(nuevoCuerpoDiferencia);
