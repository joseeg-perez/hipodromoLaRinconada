...
const obtenerMedicamentoIndividual = async (medicamentoId) => {
    try {
        const medicamento = await Medicamento.obtenerMedicamentoIndividual(medicamentoId);
...
const registrarMedicamento = async (nuevoMedicamento) => {
    try {
        const medicamentoCreado = await Medicamento.registrarMedicamento(nuevoMedicamento);
