...
const obtenerListaDePuestoCaballos = async () => {
    try {
        const listaPuestoCaballos = await PuestoCaballo.obtenerListaDePuestoCaballos();
...
const obtenerPuestoCaballoIndividual = async (puestoCaballoId) => {
    try {
        const puestoCaballo = await PuestoCaballo.obtenerPuestoCaballoIndividual(puestoCaballoId);
...
const registrarPuestoCaballo = async (nuevoPuestoCaballo) => {
    try {
        const puestoCaballoCreado = await PuestoCaballo.registrarPuestoCaballo(nuevoPuestoCaballo);
