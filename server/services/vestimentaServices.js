...
const obtenerVestimentaIndividual = async (vestimentaId) => {
  try {
    const vestimenta = await Vestimenta.obtenerVestimentaIndividual(
      vestimentaId
    );
...
const registrarVestimenta = async (nuevaVestimenta) => {
  try {
    const vestimentaCreada = await Vestimenta.registrarVestimenta(
      nuevaVestimenta
    );
...
const actualizarVestimenta = async (vestimentaId, cambios) => {
  try {
    const vestimentaActualizada = await Vestimenta.actualizarVestimenta(
      vestimentaId,
      cambios
    );
